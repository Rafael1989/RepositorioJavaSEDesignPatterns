...
public class MediaMovelSimplesTest {
	...
	@Test
	public void passandoIndicadorAbertura(){
		SerieTemporal serie = GeradorDeSerie.criaSerie(1,2,3,4,3,4,5,4,3);
		MediaMovelSimples mms = new MediaMovelSimples(3, new IndicadorAbertura());
	...
	@Test
	public void passandoIndicadorMaximo(){
		SerieTemporal serie = GeradorDeSerie.criaSerie(1,2,3,4,3,4,5,4,3);
		MediaMovelSimples mms = new MediaMovelSimples(3, new IndicadorMaximo());
	...
	@Test
	public void passandoIndicadorMinimo(){
		SerieTemporal serie = GeradorDeSerie.criaSerie(1,2,3,4,3,4,5,4,3);
		MediaMovelSimples mms = new MediaMovelSimples(3, new IndicadorMinimo());
